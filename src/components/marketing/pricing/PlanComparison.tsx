...
const ROWS: CompRow[] = [
  ...
  { category: "Real-Time Security Checks",   feature: "Real-time phishing detection on every page load",   free: false, pro: true,  enterprise: true  },
  { category: "Real-Time Security Checks",   feature: "Domain age real-time alert (newly registered)",     free: false, pro: true,  enterprise: true  },
  { category: "Real-Time Security Checks",   feature: "SSL / HTTPS certificate real-time check",           free: false, pro: true,  enterprise: true  },
  { category: "Real-Time Security Checks",   feature: "Suspicious redirect chain detection",               free: false, pro: true,  enterprise: true  },
  { category: "Real-Time Security Checks",   feature: "Real-time URL risk scoring",                        free: false, pro: true,  enterprise: true  },
  { category: "Real-Time Security Checks",   feature: "Real-time desktop threat notifications",            free: false, pro: true,  enterprise: true  },
  { category: "Real-Time Security Checks",   feature: "Real-time updates & animated charts",               free: false, pro: true,  enterprise: true  },
  ...
  { category: "Phishing & Threat Detection", feature: "Google Safe Browsing integration",                  free: true,  pro: true,  enterprise: true  },
  { category: "Phishing & Threat Detection", feature: "Free hosting detection",                            free: true,  pro: true,  enterprise: true  },
  { category: "Phishing & Threat Detection", feature: "AI Brand Detection (any company worldwide)",        free: false, pro: true,  enterprise: true  },
  ...
  { category: "Phishing & Threat Detection", feature: "Multi-layer AI engine with auto failover",          free: false, pro: true,  enterprise: true  },
  ...
  { category: "Secret & Data Protection",   feature: "Password breach monitoring (HaveIBeenPwned)",        free: false, pro: true,  enterprise: true  },
  { category: "Secret & Data Protection",   feature: "Pastejacking guard (blocks & restores clipboard)",   free: false, pro: true,  enterprise: true  },
  ...
  { category: "Browser Protection",          feature: "Link hover scanner (risk score before you click)",  free: false, pro: true,  enterprise: true  },
  ...
  { category: "Browser Protection",          feature: "Homograph / IDN attack detection",                  free: false, pro: true,  enterprise: true  },
  { category: "Browser Protection",          feature: "Subdomain abuse detection",                         free: false, pro: true,  enterprise: true  },
  { category: "Browser Protection",          feature: "Suspicious iframe & pop-up blocker",                free: false, pro: true,  enterprise: true  },

  // ── Dashboard & Reporting ────────────────────────────────────────────────
  { category: "Dashboard & Reporting",       feature: "Risk score & activity dashboard",                   free: true,  pro: true,  enterprise: true  },
  { category: "Dashboard & Reporting",       feature: "Export detection reports",                          free: true,  pro: true,  enterprise: true  },
  { category: "Dashboard & Reporting",       feature: "Advanced scan history & weekly stats",              free: false, pro: true,  enterprise: true  },
  { category: "Dashboard & Reporting",       feature: "Threat timeline & trend charts",                    free: false, pro: true,  enterprise: true  },
  { category: "Dashboard & Reporting",       feature: "Incident reports (email DLP, phishing, secrets)",   free: false, pro: false, enterprise: true  },
  { category: "Dashboard & Reporting",       feature: "Audit logs with user attribution",                  free: false, pro: false, enterprise: true  },
  ...
  { category: "Enterprise",                  feature: "Enterprise data collection & telemetry",            free: false, pro: false, enterprise: true  },
  ...
  { category: "Enterprise",                  feature: "Unlimited team members",                            free: false, pro: false, enterprise: true  },
