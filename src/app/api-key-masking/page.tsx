...
export const metadata: Metadata = {
  ...
  keywords: ["API key masking","API key detector Chrome","hide API keys browser","mask API keys extension","API key exposure detection","API key leak prevention","real-time API key detection","AWS key masking Chrome","OpenAI key masking","Stripe key detection","GitHub token masking","SecureLint API key masking","prevent API key leak","credential masking browser","mask internal API keys","console masking","sk-proj- key detection","sk_live_ key detection"],
