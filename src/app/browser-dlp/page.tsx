...
export const metadata: Metadata = {
  ...
  keywords: ["browser DLP", "browser data loss prevention", "Chrome DLP extension", "browser-native DLP", "DLP for developers", "real-time DLP Chrome", "API key DLP", "credential DLP browser", "enterprise browser DLP", "DLP without agent", "browser security DLP", "SecureLint DLP", "data loss prevention Chrome extension", "prevent data leaks browser", "what is DLP in a browser", "breached password detection", "authentication breach detection"],
