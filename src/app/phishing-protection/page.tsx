...
export const metadata: Metadata = {
  ...
  keywords: ["phishing protection Chrome","anti-phishing Chrome extension","real-time phishing detection","phishing website detector","browser phishing protection","phishing link detection","lookalike domain detection","suspicious domain alert","phishing email Chrome","phishing detection extension","SecureLint phishing","new domain age check","crypto phishing protection","malicious URL detection Chrome","IDN homograph attack","pop up phishing indicator","drainer wallet address detection","clicked phishing link"],
